  ...
  try {
    ...
    const schema: Schema = {
      ...
      properties: {
        ...
        jd_feedback: { type: Type.ARRAY, items: { type: Type.STRING } }
      },
...
${jobDescription ? `Also compare against this job description and return jd_match_score (0-100) plus jd_feedback list:\n${jobDescription}` : 'If no job description is provided, set jd_match_score to 0 and jd_feedback to empty array.'}`;
